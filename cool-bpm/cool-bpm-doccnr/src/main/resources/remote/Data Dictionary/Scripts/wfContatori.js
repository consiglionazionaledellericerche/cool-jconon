...
var wfContatori = (function () {
  ...
  function spostaDocInCatellaFlussi() {
    var nodoCartellaFlussi, nodoCartellaFlusso, i, nodoDocumento;
    ...
    logger.error("############## wfContatori.js - bpm_context: " + execution.getVariable('bpm_context'));
    for (i = 0; i < bpm_package.children.length; i++) {
      nodoDocumento = bpm_package.children[i];
      ...
      //nodoCartellaFlusso.addNode(bpm_package.children[i]);
      logger.error("############## wfContatori.js - spostaDocInCatellaFlussi -- sposto il doc: " + bpm_package.children[i].name + " nella cartella " + nodoCartellaFlusso.name + " ##############");
    }
  }
