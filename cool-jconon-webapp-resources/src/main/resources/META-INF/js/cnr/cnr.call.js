    ...
    var fieldSelect,
      ...
      itemField = {
        ...
        jsonlist : [
            ...
            Application.completeList(el['jconon_call_aspect_winner:elenco_file'], cache.jsonlistApplicationAttachments) || [],
            ...
            Application.completeList(el['jconon_call:elenco_prodotti'], cache.jsonlistApplicationAttachments) || []
          )
      },
      applicationField = {
    ...
    xhr.done(function () {
      ...
      $.each(resultSet, function (index, el) {
        ...
        if (isForCopyApplication) {
          ...
          if (common.User.admin || isConcorsi()) {
