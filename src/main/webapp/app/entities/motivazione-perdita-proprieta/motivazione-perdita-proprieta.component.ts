...
@Component({
    selector: 'jhi-motivazione-perdita-proprieta',
    templateUrl: './motivazione-perdita-proprieta.component.html'
})
export class MotivazionePerditaProprietaComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/motivazione-perdita-proprieta'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
