...
export class MultaComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.multaService
            ...
            .subscribe(
                (res: HttpResponse<IMulta[]>) => this.paginateMultas(res.body, res.headers),
    ...
    trackId(index: number, item: IMulta) {
        return item.id;
    }
    ...
    private paginateMultas(data: IMulta[], headers: HttpHeaders) {
