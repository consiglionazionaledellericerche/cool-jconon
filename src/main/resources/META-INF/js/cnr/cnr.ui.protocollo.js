define(['jquery', 'cnr/cnr'], function ($, URL) {
  ...
  function widget(id, labelText, bulkitem) {
    ...
    var input = $('<input type="text" class="input-medium" data-provide="typeahead" />').addClass(bulkitem['class']).attr('id', id).attr('name', id),
    ...
    input.keypress(function (e) {
     if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) || input.val().length >= 7) {
       return false;
      }
    });    
