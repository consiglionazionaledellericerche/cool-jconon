...
import { MultaComponent } from 'app/entities/multa/multa.component';
import { MultaService } from 'app/entities/multa/multa.service';
import { Multa } from 'app/shared/model/multa.model';

describe('Component Tests', () => {
    describe('Multa Management Component', () => {
        let comp: MultaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MultaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.multas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
