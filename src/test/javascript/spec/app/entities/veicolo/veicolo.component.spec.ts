...
import { VeicoloComponent } from 'app/entities/veicolo/veicolo.component';
import { VeicoloService } from 'app/entities/veicolo/veicolo.service';
import { Veicolo } from 'app/shared/model/veicolo.model';

describe('Component Tests', () => {
    describe('Veicolo Management Component', () => {
        let comp: VeicoloComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VeicoloComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.veicolos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
