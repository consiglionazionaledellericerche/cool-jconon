...
import { IstitutiComponent } from 'app/entities/istituti/istituti.component';
...
describe('Component Tests', () => {
    describe('Istituti Management Component', () => {
        let comp: IstitutiComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(IstitutiComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.istitutis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
