    ...
    describe('TipologiaVeicolo Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipologia-veicolos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TipologiaVeicolo', () => {
                service.create(new TipologiaVeicolo(null)).subscribe(received => {
            ...
            it('should update a TipologiaVeicolo', () => {
                service.update(new TipologiaVeicolo(123)).subscribe(received => {
            ...
            it('should return a TipologiaVeicolo', () => {
            ...
            it('should return a list of TipologiaVeicolo', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TipologiaVeicolo(123)]);
            });
