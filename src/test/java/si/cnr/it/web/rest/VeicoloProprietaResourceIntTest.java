...
public class VeicoloProprietaResourceIntTest {
    ...
    private static final String DEFAULT_ALTROMOTIVAZIONE_PERDITA_PROPRIETA = "AAAAAAAAAA";
    private static final String UPDATED_ALTROMOTIVAZIONE_PERDITA_PROPRIETA = "BBBBBBBBBB";

    private static final LocalDate DEFAULT_DATAPERDITA_PROPRIETA = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATAPERDITA_PROPRIETA = LocalDate.now(ZoneId.systemDefault());
    ...
    public static VeicoloProprieta createEntity(EntityManager em) {
        VeicoloProprieta veicoloProprieta = new VeicoloProprieta()
            ...
            .altromotivazionePerditaProprieta(DEFAULT_ALTROMOTIVAZIONE_PERDITA_PROPRIETA)
            .dataperditaProprieta(DEFAULT_DATAPERDITA_PROPRIETA);
        // Add required entity
    ...
    public void createVeicoloProprieta() throws Exception {
        ...
        assertThat(testVeicoloProprieta.getAltromotivazionePerditaProprieta()).isEqualTo(DEFAULT_ALTROMOTIVAZIONE_PERDITA_PROPRIETA);
        assertThat(testVeicoloProprieta.getDataperditaProprieta()).isEqualTo(DEFAULT_DATAPERDITA_PROPRIETA);
    }
    ...
    @Test
    @Transactional
    public void checkAltromotivazionePerditaProprietaIsRequired() throws Exception {
        int databaseSizeBeforeTest = veicoloProprietaRepository.findAll().size();
        // set the field null
        veicoloProprieta.setAltromotivazionePerditaProprieta(null);
    ...
    public void getAllVeicoloProprietas() throws Exception {
        ...
        restVeicoloProprietaMockMvc.perform(get("/api/veicolo-proprietas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].altromotivazionePerditaProprieta").value(hasItem(DEFAULT_ALTROMOTIVAZIONE_PERDITA_PROPRIETA.toString())))
            .andExpect(jsonPath("$.[*].dataperditaProprieta").value(hasItem(DEFAULT_DATAPERDITA_PROPRIETA.toString())));
    }
    ...
    public void getVeicoloProprieta() throws Exception {
        ...
        restVeicoloProprietaMockMvc.perform(get("/api/veicolo-proprietas/{id}", veicoloProprieta.getId()))
            ...
            .andExpect(jsonPath("$.altromotivazionePerditaProprieta").value(DEFAULT_ALTROMOTIVAZIONE_PERDITA_PROPRIETA.toString()))
            .andExpect(jsonPath("$.dataperditaProprieta").value(DEFAULT_DATAPERDITA_PROPRIETA.toString()));
    }
    ...
    public void updateVeicoloProprieta() throws Exception {
        ...
        updatedVeicoloProprieta
            ...
            .altromotivazionePerditaProprieta(UPDATED_ALTROMOTIVAZIONE_PERDITA_PROPRIETA)
            .dataperditaProprieta(UPDATED_DATAPERDITA_PROPRIETA);
        ...
        assertThat(testVeicoloProprieta.getAltromotivazionePerditaProprieta()).isEqualTo(UPDATED_ALTROMOTIVAZIONE_PERDITA_PROPRIETA);
        assertThat(testVeicoloProprieta.getDataperditaProprieta()).isEqualTo(UPDATED_DATAPERDITA_PROPRIETA);
    }
