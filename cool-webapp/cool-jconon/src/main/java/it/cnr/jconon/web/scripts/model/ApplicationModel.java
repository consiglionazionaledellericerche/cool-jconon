...
public class ApplicationModel {
	 ...
	 * @param contextURL
	 */
	public ApplicationModel(Folder application, OperationContext operationContext,
 Map<String, String> messages,
	...
	private void addToProperties(Property<?> property) {
		...
		if (property.getValue() != null && property.getValue() instanceof String && property.getDefinition().getPropertyType().equals(PropertyType.STRING)) {
			...
			if (property.isMultiValued())
				value = StringUtils.join(((List<?>)property.getValue()).toArray(), ",");
			else
	...
	public String getMessage(String messageKey, Object... params) {
	    ...
	    if (message == null) {
	    	message = I18NUtil.getMessage(messageKey);
	    }
	    if (message == null) {
	    	message = messageKey;
	    }
