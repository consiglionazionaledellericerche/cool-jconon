...
<p>${message('mail.print.application.2',call.getPropertyValue("jconon_call:descrizione"),call.getPropertyValue("jconon_call:sede"))}<br>${message('mail.confirm.application.3',serverPath+url.context)}</p> 
